  ...
  return (
    <div className="flex w-screen h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 h-full overflow-hidden transition-all duration-300">
        ...
        {/* Dashboard Footer */}
        <footer className="flex items-center justify-center h-14 border-t border-slate-200 dark:border-slate-800/80 px-8 bg-white dark:bg-slate-900 text-center transition-colors duration-200 flex-shrink-0">
